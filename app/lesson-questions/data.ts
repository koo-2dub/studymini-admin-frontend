...
export const lessonQuestions: LessonQuestionRecord[] = [
  ...
  },
  {
    ...
    questionBody: "미션 문장에서 ‘Have you ever been to Canada?’를 배웠는데, 영화에서는 ‘Did you ever go there?’도 들었습니다.\n두 표현 모두 경험을 묻는 것처럼 들리는데 어떤 상황에서 현재완료를 써야 하는지 설명 부탁드립니다.",
    visibilityStatus: "승인됨",
    answerStatus: "미답변",
  ...
  },
  {
    ...
    questionBody: "감사를 표현할 때 현재형과 과거형이 모두 쓰이는 것 같은데, 수업이 끝난 뒤 선생님께 말할 때는 어떤 표현이 자연스러운지 궁금합니다.\n예문을 함께 알려주세요.",
  ...
  },
  {
    ...
    questionBody: "Heute lerne ich Deutsch에서 Heute가 앞에 오면 주어와 동사의 위치가 바뀌는 이유가 궁금합니다.\nIch lerne heute Deutsch와 의미 차이가 큰지도 알려주세요.",
