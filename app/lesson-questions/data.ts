...
export const lessonQuestions: LessonQuestionRecord[] = [
  {
    ...
    questionBody:
      "강의에서는 pretérito perfecto가 현재와 연결된 경험을 말할 때 자주 쓰인다고 설명해 주셨는데, 실제 예문에서 ayer가 붙으면 indefinido를 쓴다고 해서 헷갈립니다. 제가 작성한 문장 ‘He estudiado español ayer’는 왜 어색한지, 자연스럽게 고치려면 어떤 시제를 써야 하는지 알고 싶습니다.",
    ...
    answerBody:
      "ayer처럼 과거의 특정 시점을 명확히 닫아 주는 표현이 있으면 indefinido를 쓰는 것이 자연스럽습니다. 따라서 ‘Estudié español ayer’가 맞고, 오늘까지 이어지는 경험을 말할 때는 ‘He estudiado español esta semana’처럼 쓰면 됩니다.",
  ...
  },
  {
    ...
    questionBody:
      "미션 문장에서 ‘Have you ever been to Canada?’를 배웠는데, 영화에서는 ‘Did you ever go there?’도 들었습니다. 두 표현 모두 경험을 묻는 것처럼 들리는데 어떤 상황에서 현재완료를 써야 하는지 설명 부탁드립니다.",
    visibilityStatus: "승인됨",
    answerStatus: "미답변",
  ...
  },
  {
    ...
    questionBody:
      "감사를 표현할 때 현재형과 과거형이 모두 쓰이는 것 같은데, 수업이 끝난 뒤 선생님께 말할 때는 어떤 표현이 자연스러운지 궁금합니다. 예문을 함께 알려주세요.",
  ...
  },
  {
    ...
    questionBody:
      "‘我把昨天买的书放在桌子上了’ 같은 문장에서 목적어가 길어지면 문장이 너무 복잡해 보입니다. 실제 회화에서도 이렇게 말하는지, 짧게 나누는 방법이 있는지 알고 싶습니다.",
    visibilityStatus: "승인됨",
    answerStatus: "답변완료",
    ...
    answerBody:
      "목적어가 길어도 把 뒤에 한 덩어리로 놓을 수 있습니다. 다만 회화에서는 ‘我昨天买了一本书。把它放在桌子上了。’처럼 앞 문장에서 대상을 먼저 소개하고 다음 문장에서 它로 받으면 더 자연스럽습니다.",
    attachments: [],
    logs: [
  ...
  },
  {
    ...
    questionBody:
      "카페에서 주문할 때 Je voudrais un café가 정중하다고 배웠습니다. 친구끼리 가벼운 상황에서는 Je veux un café라고 해도 무례하지 않은지, 다른 추천 표현이 있는지 알고 싶습니다.",
    visibilityStatus: "승인 대기",
    answerStatus: "미답변",
  ...
  },
  {
    ...
    questionBody:
      "Heute lerne ich Deutsch에서 Heute가 앞에 오면 주어와 동사의 위치가 바뀌는 이유가 궁금합니다. Ich lerne heute Deutsch와 의미 차이가 큰지도 알려주세요.",
  ...
  },
  {
    ...
    questionBody:
      "호텔 체크인 상황에서 정중한 표현을 연습하고 있습니다. Vorrei fare il check-in이 자연스럽다고 배웠는데, voglio fare il check-in과 비교해서 어떤 뉘앙스 차이가 있는지 알려주세요.",
    visibilityStatus: "휴지통",
    answerStatus: "답변완료",
