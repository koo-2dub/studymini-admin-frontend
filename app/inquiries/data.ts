...
export const inquiries: Inquiry[] = [
  {
    ...
    content: "지난 결제 건에 대한 영수증을 회사 제출용으로 발급받고 싶습니다. 결제자명도 함께 확인 부탁드립니다.",
  ...
  },
  {
    ...
    inquiryDate: "2026-06-01",
    answeredAt: "-",
    content: "결제 후 녹화 강의 목록에 들어가면 권한이 없다는 메시지가 보입니다. 수강 기간은 남아 있는 것으로 확인됩니다.",
    answer: "",
  },
  {
    id: "INQ-306",
    ...
    answeredAt: "-",
    content: "팀 플랜 좌석 2개를 다음 결제일부터 취소하고 싶습니다. 남은 기간 정산 방식도 안내 부탁드립니다.",
    answer: "",
  },
  {
    id: "INQ-307",
