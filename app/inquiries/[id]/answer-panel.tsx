...
import { currentAdminName, type Inquiry, type InquiryStatus } from "../data";
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <label className="space-y-2 text-sm font-bold text-slate-700">
            답변
            <textarea
              className="min-h-48 w-full rounded-2xl border border-input bg-white/80 p-4 text-sm leading-6 outline-none transition focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100"
          ...
          <div className="flex justify-end">
            <Button type="button" onClick={saveAnswer} disabled={!answer.trim()}>답변 저장</Button>
          </div>
        </CardContent>
      </Card>
